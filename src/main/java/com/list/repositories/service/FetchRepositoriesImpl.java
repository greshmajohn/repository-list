...
public class FetchRepositoriesImpl implements FetchRepositories {
	...
	public FetchRepositoriesImpl(RestTemplate restTemplate) {
		this.restTemplate=restTemplate;
	}
	

	@Override
	public String getRepositories(LocalDate date, String language, Integer page, Integer pageSize) {
		/*
